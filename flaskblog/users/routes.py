...
def registerPage():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f"Your account has been successfully created as {form.username.data}! Please Login now.",category="success")
...
def loginPage():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password,form.password.data):
            ...
            flash(f"You have been logged in successfully as {user.username}!",category="success")
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f"Your password has been successfully updated!Please Login now.",category="success")
        return redirect(url_for('users.loginPage'))
